...
It's a basic game and all the assets (even most part of the scripts) are all ready to use.
...
Well that's all I wanted to talk about this tutorial, looking forward to my next "tut-project".